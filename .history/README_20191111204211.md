...
* Foi criado uma pasta domínio foi guardadas as classes de regra de negócio outra pasta repositório para as classes de crud, camada de acesso aos dados e uma classe para conexão com o PostgreSQL.

* Utilizando o nuget PGSQL nativo para a versão do PostgreSQL correspondente
